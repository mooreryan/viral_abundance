...
default_references = '/home/moorer/public/artificial_metagenomes/' +
  'sequences/fastas/genomes/all_10.fa'
default_scaf_seq = '/Users/ryanmoore/projects/steve/viral_abundance/' +
  'test_files/inputs/test_127.scafSeq'
default_blast = '/usr/bin/blastn'
default_blast_db = '/home/moorer/public/artificial_metagenomes/' + 
  'blast_dbs/all10.fa'
default_outdir = '/Users/ryanmoore/projects/steve/viral_abundance/' + 
  'test_files/output'

opts = Trollop.options do
  banner <<-EOS

  If the scaf_seq file is `test_127.scafSeq` then the output files
  will be these:
  ...
  opt(:references, 'The fasta file of reference sequences',
      type: :string, default: defualt_references)
  opt(:scaf_seq, 'The scafSeq file from SOAPdenovo', type: :string,
      default: default_scaf_seq)
...
## print top hits
puts %w[query tax-hit eval start stop length].join("\t")
hits.each_pair do |query, info|
